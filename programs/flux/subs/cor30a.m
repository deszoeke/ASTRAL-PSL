function [y, U10N, T10N, Q10N] = cor30a(x)   %  modified to output 10m U,T,Q - 7/2015 BWB
...
hwave=x(19);%wave height (m)
  ...
  for i=1:nits;
     ...
     %************  10m neutral values  7/2015 BWB - as done in C35
     S = ut;
     U = du;
     gf = S/U;
     psi10 = psiu_30(10/L);
     ...
     Q = Q*1000;
     qsrg = qsr*1000;
     Q10 = Q + qsrg/von*(log(10/zq)-psi10T+psiT);
     Q10N = Q10 + psi10T*qsrg/von;
