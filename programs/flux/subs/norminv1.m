function [x,xlo,xup] = norminv1(p,mu,sigma,pcov,alpha)
%NORMINV1 Inverse of the normal cumulative distribution function (cdf).
%   X = NORMINV1(P,MU,SIGMA) returns the inverse cdf for the normal
...
%
%   [X,XLO,XUP] = NORMINV1(P,MU,SIGMA,PCOV,ALPHA) produces confidence bounds
...
if nargin<1
    error('stats:norminv1:TooFewInputs','Input argument P is undefined.');
end
if nargin < 2
    mu = 0;
end
...
try
    ...
    error('stats:norminv1:InputSizeMismatch',...
