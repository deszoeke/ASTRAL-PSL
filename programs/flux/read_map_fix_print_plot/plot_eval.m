function plot_eval(a1, a10, path_prog, path_raw_images)
...
% PRESSURE
figure; plot(a10.jd,a10.psealevel_s,'b-',a10.jd,a10.psealevel,'r-'); grid;
...
plot(a10.jd,a10.lw_case_t_1+tc1_adj,'-', a10.jd, a10.lw_dome_t_1+td1_adj,'-', a10.jd, a10.lw_case_t_2+tc2_adj,'-',...
    a10.jd,a10.lw_dome_t_2+td2_adj,'-', a10.jd,a10.ta,'-k', a10.jd,a10.ta_s,'--k');
...
legend('case PIR-1','dome PIR-1','case PIR-2','dome PIR-2','PSL vaisala','ship','Location','BestOutside');
xlabel('Hour (UTC)'); ylabel('Temperature (^oC)');
xlim([the_jd the_jd+1]); grid;
set(gca(gcf),'XTick',the_jd:2/24:the_jd+1); datetick('x','HH:MM','keepticks');
xax = get(gca(gcf),'XTickLabel'); xax(end,:)='24:00'; set(gca(gcf),'XTickLabel',xax(:,1:2));

%%%  in case one is way off... can use this as a two-panel figure 
% subplot(2,1,2);
% plot(a10.jd,a10.lw_dome_t_2+td2_adj);
% title(sprintf('%s %04i-%02i-%02i DOY%03i All Temperatures',cruise_str,the_yr,the_mo,the_day,the_jd),'FontWeight','Bold','Interpreter','none');
% legend('dome PIR-2','Location','BestOutside');
% xlabel('Hour (UTC)'); ylabel('Temperature (^oC)');
% xlim([the_jd the_jd+1]); grid;
% set(gca(gcf),'XTick',the_jd:2/24:the_jd+1); datetick('x','HH:MM','keepticks');
% xax = get(gca(gcf),'XTickLabel'); xax(end,:)='24:00'; set(gca(gcf),'XTickLabel',xax(:,1:2));
...
% AIR TEMPERATURES
figure; plot(a10.jd,a10.ta_s,'-b',a10.jd,a10.ta,'-r');
...
% tc_sh_adj = nanmean1(a10.ta(wh_night)-a10.lw_dome_t_s(wh_night)); disp(['tc_sh_adj = ',sprintf('%4.2f',tc_sh_adj)]);
% td_sh_adj = nanmean1(a10.ta(wh_night)-a10.lw_dome_t_s(wh_night)); disp(['td_sh_adj = ',sprintf('%4.2f',td_sh_adj)]);
...
%     a10.jd,a10.ta-a10.lw_case_t_s,'-',a10.jd,a10.ta-a10.lw_dome_t_s,'-');
title(sprintf('%s %4.2f %s %4.2f %s %4.2f %s %4.2f','air-IR dT night: case 1: ',...
...
% RELATIVE HUMIDITY
figure; plot(a10.jd, a10.rh_s,'b-',a10.jd, a10.rh, 'r-'); grid;
...
figure; hold on;
plot(a1.jd,  a1.orgV_desp,'og',a1.jd,a1.orgV,'r.');grid;
...
xlabel('Hour (UTC)'); ylabel('Volts'); xlim([the_jd the_jd+1]); ylim([0.03,1.0]);
text(a1.jd(10),0.14,['orgV adj = ',sprintf('%6.4f',orgV_adj),' V'],'fontsize',18);
set(gca(gcf),'XTick',the_jd:2/24:the_jd+1);datetick('x','HH:MM','keepticks');
legend({'despiked raw','raw','median offset','target offset'},'location','eastoutside');
xax = get(gca(gcf),'XTickLabel'); xax(end,:)='24:00'; set(gca(gcf),'XTickLabel',xax(:,1:2));
annotation(gcf,'textbox',[0.007154 0.01077 0.4498 0.02462],'String',{'NOAA PSL'},'FontSize',14,'FitBoxToText','off','LineStyle','none');
...
% SST
figure; plot(a10.jd,a10.tsea_s,'-b',a10.jd,a10.tsea_in_s,'--g', a10.jd, a10.tsnk,'-r', a10.jd, a10.tskin,'ok'); grid;
...
legend(['ship TSG ' sprintf('%3.1f',zsea_ship) ' m'],['ship intake ' sprintf('%3.1f',zsea_ship) ' m'],...
    'PSL snake 0.05 m','COARE skin','location','BestOutside');
set(gca(gcf),'XTick',the_jd:2/24:the_jd+1); datetick('x','HH:MM','keepticks');
xax = get(gca(gcf),'XTickLabel'); xax(end,:)='24:00'; set(gca(gcf),'XTickLabel',xax(:,1:2));
annotation(gcf,'textbox',[0.007154 0.01077 0.4498 0.02462],'String',{'NOAA PSL'},'FontSize',14,'FitBoxToText','off','LineStyle','none');
...
% GPS SOG/COG
figure;
subplot(2,1,1); plot(a10.jd, a10.sog_s,'-b',a10.jd, a10.sog,'--r');
...
subplot(2,1,2); plot(a10.jd, a10.cog_s,'ob',a10.jd, a10.cog,'.r'); legend('ship','PSL','location','BestOutside');
...
% HEADING
figure; plot(a10.jd, a10.hed_s, 'bo',a10.jd, a10.hed,'r.');
...
% PITCH ANGLE
figure; plot(a10.jd,a10.pitch,'r-'); grid;
...
figure; 
% subplot(2,1,1);
plot(a10.jd, a10.lw_dn_1,'r',a10.jd, a10.lw_dn_2,'k',a10.jd, a10.lw_dn_s,'b',a10.jd,a10.lw_dn_clr,'--g'); xlim([the_jd the_jd+1]);
...
%%% in case one is way off, do 2-panel figure
% subplot(2,1,2);
...
figure;
plot(a10.jd,a10.lw_therm_1,'-', a10.jd, a10.lw_therm_2,'-');
...
legend('therm PIR-1','therm PIR-2','Location','BestOutside');
...
figure; plot(a10.jd, a10.sw_dn_1,'r',a10.jd, a10.sw_dn_2,'k', a10.jd, a10.sw_dn_s,'b',a10.jd, a10.sw_dn_clr,'--g'); xlim([the_jd the_jd+1]);
